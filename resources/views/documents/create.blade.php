...
<script>
    ...
    function mostrar(){
        if(document.getElementById("avisarEmp").checked){

            document.getElementById("labelCif").hidden = false;
            document.getElementById("selectCif").hidden = false;
        }else{

            document.getElementById("labelCif").hidden = true;
            document.getElementById("selectCif").hidden = true;
            document.getElementById("labelEmpresa").hidden = true;
            document.getElementById("selectEmpresa").hidden = true;
            document.getElementById("labelEmpleado").hidden = true;
            document.getElementById("selectEmpleado").hidden = true;
...
<div class="center">
    <div class="tarjeta">
        <div class="titulo" style="background-color:#F7AB40">
            <h5><strong>Añadir Documento</strong></h5>
        </div>
            ...
            <div class="cuerpo">
                <form method="POST" action="{{ route('documents.store') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                            ...
                            <input type="file" class="form-control-file" id="doc" accept="application/pdf" name="doc" multiple required></input>
                        Tipo:  
                    ...
                    @else
                    <select class="form-control{{ $errors->has('centro') ? ' is-invalid' : '' }}" id="tipo" name="tipo" style="margin:10px">
                    <option selected></option>
                    ...
                    <div style="margin:10px">
                        Avisar a supervisor: 
                        <input type="checkbox" id="avisarSup" name="avisarSup">
                    </div>
                    @else
                    <div style="margin:10px">
                        Adjuntar a empleado: 
                        <input onchange="mostrar()" type="checkbox" id="avisarEmp" name="avisarEmp">
                    ...
                    ?>
                        ...
                        <label for="selectCif" id="labelCif" class="col-md-4 col-form-label text-md-right" hidden>{{ __('CIF:') }}</label>
                        <select style="margin:10px" id='selectCif' onchange='cargarSelectEmpresa(this.value);' hidden> 
                            <option selected></option>
                    ...
                    <div>
                        ...
                        <select style="margin:10px" id='selectEmpresa'  onchange='cargarSelectEmpleado(this.value);' hidden > </select> 
                    ...
                    <div>
                        ...
                        <select id='selectEmpleado' name='selectEmpleado' hidden > </select>
